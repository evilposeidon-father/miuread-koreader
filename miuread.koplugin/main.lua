...
local Reader=Lazy("miuread.content_reader")
local Protocol=require("miuread.protocol")
local MP=require("miuread.mp")
local Access=require("miuread.access")
local Annotations=Lazy("miuread.annotations")
local LocalAnnotationDatabase=Lazy("miuread.local_annotation_database")
local AnnotationSync=Lazy("miuread.annotation_sync")
local Downloader=Lazy("miuread.downloader")
local DownloadProgress=Lazy("miuread.download_progress")
local DownloadTask=Lazy("miuread.download_task")
...
local CacheCleanupTask=Lazy("miuread.cache_cleanup_task")
...
local ExternalAnnotationsDB=Lazy("miuread.external_annotations_db")
local ExternalAnnotationSync=Lazy("miuread.external_annotation_sync")
