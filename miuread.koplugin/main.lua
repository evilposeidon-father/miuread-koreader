...
-- Reader quick panel (down-swipe menu bar) keeps at most eight one-tap
-- shortcuts. Defaults match the previous hard-coded action row; the remaining
-- definitions stay available in the reader quick panel settings.
...
local function mark_reader_origin(path)
    ...
    home.reader_file = normalized_reader_file(path) or home.reader_file
end
