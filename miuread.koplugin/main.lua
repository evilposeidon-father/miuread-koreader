...
local PluginHighlightPolicy=require("miuread.highlight_policy")
...
PluginReaderLifecycleIO.install(Plugin)
PluginHighlightPolicy.install(Plugin)
...
PluginHomePreferencesIO.install(Plugin)
PluginHomeLocalInline.install(Plugin)
...
function Plugin:init()
    ...
    self._miuread_shelf_refresh_generation=0
