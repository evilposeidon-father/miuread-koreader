...
local AnnotationText = require("miuread.annotation_text")
local utf8_len_at = AnnotationText.utf8_len_at
local NAMED_ENTITIES = AnnotationText.NAMED_ENTITIES
local utf8_encode = AnnotationText.utf8_encode
local decode_html_unit = AnnotationText.decode_html_unit
local split_units = AnnotationText.split_units
local is_ignorable_text = AnnotationText.is_ignorable_text
local SKIP_TEXT_TAGS = AnnotationText.SKIP_TEXT_TAGS
local tag_info = AnnotationText.tag_info
local tokenize = AnnotationText.tokenize
local utf16_width = AnnotationText.utf16_width
local build_text_index = AnnotationText.build_text_index
local normalize_text = AnnotationText.normalize_text
