...
local ChapterTitle = require("miuread.chapter_title")
local normalized_book = ChapterTitle.normalized_book
local css_add = ChapterTitle.css_add
local plain = ChapterTitle.plain
local fold_fullwidth = ChapterTitle.fold_fullwidth
local BLANK_PATTERNS = ChapterTitle.BLANK_PATTERNS
local normalized_title = ChapterTitle.normalized_title
local trim_lead = ChapterTitle.trim_lead
local CJK_DIGITS = ChapterTitle.CJK_DIGITS
local NUMBER_UNITS = ChapterTitle.NUMBER_UNITS
local NUMBER_SEPARATORS = ChapterTitle.NUMBER_SEPARATORS
local has_number_unit = ChapterTitle.has_number_unit
local title_is_numbered = ChapterTitle.title_is_numbered
local TITLE_SCAN_LIMIT = ChapterTitle.TITLE_SCAN_LIMIT
local TITLE_SCAN_WINDOW = ChapterTitle.TITLE_SCAN_WINDOW
local TITLE_SCAN_HEADINGS = ChapterTitle.TITLE_SCAN_HEADINGS
local TITLE_SLACK_BYTES = ChapterTitle.TITLE_SLACK_BYTES
local attribute = ChapterTitle.attribute
local heading_labels = ChapterTitle.heading_labels
local collect_headings = ChapterTitle.collect_headings
local normalized_title_legacy = ChapterTitle.normalized_title_legacy
