...
local ContentClassify = require("miuread.content_classify")
local visible_text = ContentClassify.visible_text
local truthy = ContentClassify.truthy
local is_structure_chapter = ContentClassify.is_structure_chapter
local is_cover_chapter = ContentClassify.is_cover_chapter
local is_unavailable_chapter = ContentClassify.is_unavailable_chapter
local has_content_markup = ContentClassify.has_content_markup
local has_readable_content = ContentClassify.has_readable_content
local structure_xhtml = ContentClassify.structure_xhtml
local image_only_xhtml = ContentClassify.image_only_xhtml
local readable_text_length = ContentClassify.readable_text_length
local is_empty_error = ContentClassify.is_empty_error
local is_confirmed_empty_error = ContentClassify.is_confirmed_empty_error
local is_auth_error = ContentClassify.is_auth_error
local is_access_denied_error = ContentClassify.is_access_denied_error
local login_page_error = ContentClassify.login_page_error
local raw_service_auth_error = ContentClassify.raw_service_auth_error
local CONFIRMED_EMPTY = ContentClassify.CONFIRMED_EMPTY
