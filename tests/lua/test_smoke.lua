...
function T.test_load_main_and_controllers()
    ...
    test_method(plugin, "_ensure_sync_scheduler")
    test_method(plugin, "_sync_scheduler_request")
    test_method(plugin, "_sync_scheduler_run_now")
    test_method(plugin, "_sync_gate_allowed")
    test_method(plugin, "download")
    test_method(plugin, "show_reader_quick_panel")
    test_method(plugin, "_apply_miuread_highlight_defaults")
    test_method(plugin, "sync_external_chapter")
    test_method(plugin, "_external_annotation_dynamic_hint")
