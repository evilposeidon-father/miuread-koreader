...
- 代码文件：129
- 代码行数：约 65550
- 主要语言：.lua 124、.py 4、.json 1
- 项目大小：2909.2 KB
- 最后更新：2026-08-16 02:20
- 摘要生成时间：2026-08-16 02:21

## 文件清单（前 60）

- `miuread.koplugin\main.lua`（11840 行）
...
- `miuread.koplugin\miuread\plugin_preferences.lua`（720 行）
...
- `tests\test_project_invariants.py`（291 行）
