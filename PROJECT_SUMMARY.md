...
- 代码文件：158
- 代码行数：约 67009
- 主要语言：.lua 153、.py 4、.json 1
- 项目大小：2970.5 KB
- 最后更新：2026-08-16 03:28
- 摘要生成时间：2026-08-16 03:29

## 文件清单（前 60）

- `miuread.koplugin\main.lua`（7306 行）
...
- `miuread.koplugin\miuread\plugin_shelf.lua`（855 行）
...
- `tests\test_project_invariants.py`（350 行）
